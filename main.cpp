...
#include "src/DCC_Processing/DCC_Processing.h"
...
// #include "src/DCC_Kinetic/DCCKinetic.h"
...
// #include "src/DCC_Characterisation/StructureCharacterisation.h"
/* Writer module perform formatted output of various data structures generated by other modules */
#include "src/DCC_Writer/DCC_Writer.h"
...
/// ===== Elapsing time Writer ================
        ...
        cout << "-------------------------------------------------------" << endl;
         ...
         if (WriterON(confpath, time_step_one)) { // simply output ON/OFF for the DCC_Writer module on the screen
             ...
             DCC_Writer(special_faces_sequence, ordinary_faces_sequence);
/// ===== Elapsing time Writer ================
