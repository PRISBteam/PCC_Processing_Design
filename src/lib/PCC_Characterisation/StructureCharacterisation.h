...
vector<double> TJsTypes, cTJsTypes;
...
string output_Entropy_dir = output_dir + "TJsLab_TJsEntropy.txt"s; char* cEntropy_dir = const_cast<char*>(output_Entropy_dir.c_str());
