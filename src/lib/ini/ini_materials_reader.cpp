...
//    Out_logfile_stream.open(output_dir + "Processing_Design.log"s, ios::app); // this *.log stream will be closed at the end of the main function
    ...
    if (inclusion1_mass_density > std::pow(10,-100)) Out_logfile_stream << "Inclusion density [kg/m^3] .............. " << inclusion1_mass_density << endl;
    if (inclusion1_coh_energy > std::pow(10,-100)) Out_logfile_stream << "Agglomeration cohesion energy density [J/m^2] .............. " << inclusion1_coh_energy << endl;
