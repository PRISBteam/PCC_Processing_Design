...
//    Eigen::SparseMatrix<double> adjacency and incidence matrices
    ...
    Eigen::SparseMatrix<double> ENS = SMatrixReader(paths_to_PCC_matrices.at(4 + (PCC_dimension - 3)), (CellNumbs.at(0)), (CellNumbs.at(1))); //all Nodes-Edges
    Eigen::SparseMatrix<double> FES = SMatrixReader(paths_to_PCC_matrices.at(5 + (PCC_dimension - 3)), CellNumbs.at(1), CellNumbs.at(2)); // Edges-Faces
    Eigen::SparseMatrix<double> GFS = SMatrixReader(paths_to_PCC_matrices.at(6 + (PCC_dimension - 3)), (CellNumbs.at(2)), (CellNumbs.at(3))); //all Faces-Grains
