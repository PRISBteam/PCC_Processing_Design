...
std::vector <unsigned int> DCC_Kinetic(std::vector<double> &face_elastic_energies, std::vector<unsigned int> &s_faces_sequence, macrocrack &large_crack, string K_type) {
...
/*    string  ncells = input_dir + "number_of_cells.txt"s; char* number_of_cells = const_cast<char*>(ncells.c_str());
...
////////////////////////////////////// KINETIC PROCESSES ///////////////////////////////////////////////
    ...
    /// #2# Kinetic type WEAR
        ...
        /// ======= Kinetic function ===================>>
//        DCC_Kinetic_Wear(ShearStress, Grain_Orientations, FES, CellNumbs, input_dir, odir);
...
//        fraction_stress_temperature = DCC_Kinetic_Plasticity(FES, CellNumbs, input_dir, odir);
