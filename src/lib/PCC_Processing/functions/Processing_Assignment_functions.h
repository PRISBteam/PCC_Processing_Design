...
// special_cells_fraction
        ...
        if (number_of_types > 1) { // int NewFaceType = 1;
            if (scell_fractions_vector.at(0) < max_fractions_vectors[cell_type].at(0))
                NewFaceType = 1;
            else if (scell_fractions_vector.at(1) < max_fractions_vectors[cell_type].at(1))
                NewFaceType = 2;             //            int preFaceType = rand() % number_of_types; // Random chose for the chose of cell's type to be assigned over all special types
            else if (scell_fractions_vector.at(2) < max_fractions_vectors[cell_type].at(2))
                NewFaceType = 3;
        } // end of if (number_of_types > 1)
// REPAIR        cout << " cell_type " << cell_type << " number_of_types " << number_of_types << endl;
// REPAIR        cout << max_fractions_vectors[cell_type].at(0) << " " <<  max_fractions_vectors[cell_type].at(1) << " " << max_fractions_vectors[cell_type].at(2) << endl;
// REPAIR        cout << scell_fractions_vector.at(0) << " " <<  scell_fractions_vector.at(1) << " " <<  scell_fractions_vector.at(2) << endl;
...
// number of cell types
    int number_of_types = std::count_if(max_fractions_vectors[cell_type + (dim0 - 3)].begin(), max_fractions_vectors[cell_type + (dim0 - 3)].end(), [](double c){return c > 0;});
