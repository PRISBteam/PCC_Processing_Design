...
///
std::vector <unsigned int> special_x_sequence, special_xx_sequence, special_xxx_sequence, current_sx_sequence; // variable sequences (in order of their generation) of special and ordinary k-cells
...
std::vector<vector<double>> max_fractions_vectors(4), max_2fractions_vectors(4), max_3fractions_vectors(4), max_cfractions_vectors(4); // [0][..] - nodes, [1][..] - edges, [2][..] - faces, [3][..] - polyhedrons
...
/// RANDOM generation of additional precipitate phases
//    max_2fractions_vectors[cell_type][1] = max_fractions_vectors[cell_type][1]; // formal replacing
//    special_xx_sequence = Processing_Random(cell_type, Configuration_State, max_2fractions_vectors);
//    max_3fractions_vectors[cell_type][2] = max_fractions_vectors[cell_type][2]; // formal replacing
//    special_xxx_sequence = Processing_Random(cell_type, Configuration_State, max_3fractions_vectors);
