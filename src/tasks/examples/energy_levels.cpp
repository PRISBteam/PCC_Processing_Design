...
//    characterisation_logfile_stream << "S11(MPa)" << " " << "S22(MPa)" << " " << "S33(MPa)" << " " << "S12(MPa)" << " " << "S13(MPa)" << " " << "S23(MPa)" << " " << "Pressure(MPa)" << " " << "Mizes(MPa)" << " " << "T_factor" << " " << " alpha_t " << " " << " A2 " << " " << " A3 " << " "  << " A6 " << " " << " B2 " << " " << " B4 " << " "  << " B5 " << " " << " C1 " << " " << " C3 " << " "  << " C5 " << " " << " D1 " << " " << " D4 " << " " << " D6 " << endl;

//for(auto f_out : factors) {
//        characterisation_logfile_stream << f_out.at(0) << " " << f_out.at(1) << " " << f_out.at(2) << " " << f_out.at(3) << " " << f_out.at(4) << " " << f_out.at(5) << " " << f_out.at(6) << " " << f_out.at(7) << " " << f_out.at(8) << " " << " alpha_t " << " " << " e1 " << " " << " e2 " << " " << " e3 " << " " << " " << " e4 " << " " << " e5 " << " " << " e6 " << " " << " e7 " << " " << " e8 " << " " << " e9 " << " " << " e10 " << " " << " e11 " << " " << " e12 " << " " << endl;
