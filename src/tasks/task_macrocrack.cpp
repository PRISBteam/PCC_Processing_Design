...
cout << "START of the DCC Processing module" << endl; Out_logfile_stream << "START of the DCC Processing module" << endl;
/*        if (P_type != "L") {
...
cout << "START of the DCC Subcomplex module" << endl; Out_logfile_stream << "START of the DCC Subcomplex module" << endl;
...
cout << "Subcomplex time is equal to  " << Sub_time / pow(10.0, 6.0) << "  seconds" << endl; cout << "-------------------------------------------------------------------------" << endl;
Out_logfile_stream << "Subcomplex time is equal to  " << Sub_time / pow(10.0, 6.0) << "  seconds" << endl; Out_logfile_stream << "-------------------------------------------------------------------------" << endl;
...
cout << "START of the DCC Kinetic module" << endl; Out_logfile_stream << "START of the DCC Kinetic module" << endl;
...
cout << "Kinetic time is equal to  " << K_time / pow(10.0, 6.0) << "  seconds" << endl; cout << "-------------------------------------------------------------------------" << endl;
Out_logfile_stream << "Kinetic time is equal to  " << K_time / pow(10.0, 6.0) << "  seconds" << endl; Out_logfile_stream << "-------------------------------------------------------------------------" << endl;
...
cout << "Writer time is equal to  " << W_time / pow(10.0, 6.0) << "  seconds" << endl; cout << "-------------------------------------------------------------------------" << endl;
Out_logfile_stream << "Writer time is equal to  " << W_time / pow(10.0, 6.0) << "  seconds" << endl; Out_logfile_stream << "-------------------------------------------------------------------------" << endl;
